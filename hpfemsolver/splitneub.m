function [Meshsq,Meshst,splitq,orders,splitt]=splitneub(ne,order,Meshq,nelemq,Mesht,nelemt,dir,glob,edges)
...
%     store con data for plotting....    
   ...
   for j=1:nptri
      [coordn(cont(j),1),coordn(cont(j),2)]=getcoordt(xyt,epett(j,1),epett(j,2));   
   end

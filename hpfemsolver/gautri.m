...
% Compute the weights and locations a triangular element
% outputs:
% intxi: list of quadrature points xi component
% inteta: list of quadrature points eta component 
% intw: list of associated weights
